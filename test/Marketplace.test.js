...
contract('Marketplace', ([deployer, seller, buyer]) => {
    ...
    describe('products', async () => {
        ...
        it('seller products', async () => {
            ...
            const expectedBallance = oldSellerBalance.add(price)

            assert.equal(newSellerBalance.toString(), expectedBallance.toString())
            ...
            // failure: buyer tries to buy again, i.e., product can't be the seller
